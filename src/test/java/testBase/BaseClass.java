...
@Parameters({"os","browser"})
    ...
    if(assetPage.isAccountLoggedMessageDisplayed())
	...
	// Converts ₹50,000.00 → BigDecimal 50000.00
    public String freshCurrency(String value) {
//        String cleaned = value.replaceAll("[^\\d.]", "");  // removes ₹, commas etc.
//        return cleaned;
    	return value.replaceAll("[^\\d.]", "").replace(".00", "").trim();
    }
