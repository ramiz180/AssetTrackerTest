    ...
    public void verify_add_new_lease() {
        ...
        try {
         ...
         // Step 1: Navigate to Lease Page
            ...
            addLeasePage.SetReimbursements("4999");
            addLeasePage.selectSalesPerson(2);
            addLeasePage.enterCustomerName("AAKAR SCIENTIFIC PRIVATE", "AAKAR SCIENTIFIC PRIVATE LIMITED - 24AABCA5384K1ZL");
            
            // Step 4: Add Machine Details
            logger.info("Adding Machine Details...");
            addLeasePage.clickAddMachine();
            
            addLeasePage.selectAssetNo(assetNumber, assetNumber);
            addLeasePage.selectNumberOfOperators("1");
            //addLeasePage.selectOperatorName("manabi");
            addLeasePage.selectOperatorName("man", "manabi");
            addLeasePage.enterRentalStartDate(LocalDate.now().toString());
            addLeasePage.enterRentalEndDate("2025-12-12");
